...
LEVELS: List[LevelConfig] = [
    LevelConfig(
        ...
        raccoon_count=3, wariness_scale=1.0, speed_scale=1.0,
    ),
    LevelConfig(
        level_num=2, score_target=250, time_limit_sec=180.0,
        raccoon_count=4, wariness_scale=1.2, speed_scale=0.75,
    ),
    LevelConfig(
        level_num=3, score_target=500, time_limit_sec=180.0,
        raccoon_count=5, wariness_scale=1.5, speed_scale=0.55,
    ),
]
